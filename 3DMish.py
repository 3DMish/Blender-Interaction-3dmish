...
kmi = km.keymap_items.new_modal('BEGIN', 'LEFTMOUSE', 'PRESS', shift=True, ctrl=True, alt=True)
...
kmi = km.keymap_items.new('view3d.screencast_keys', 'C', 'PRESS', shift=True, alt=True)
kmi = km.keymap_items.new('view3d.screencast_keys', 'C', 'PRESS', shift=True, alt=True)
kmi = km.keymap_items.new('view3d.snap_cursor_to_center', 'MIDDLEMOUSE', 'PRESS', key_modifier='C')
kmi = km.keymap_items.new('view3d.snap_cursor_to_selected', 'MIDDLEMOUSE', 'PRESS', key_modifier='S')
kmi = km.keymap_items.new('view3d.snap_selected_to_cursor', 'LEFTMOUSE', 'PRESS', key_modifier='S')
...
kmi_props_setattr(kmi.properties, 'data_path', 'tool_settings.snap_element')
kmi_props_setattr(kmi.properties, 'value', 'INCREMENT')
...
kmi = km.keymap_items.new('mesh.loopcut_slide', 'C', 'PRESS', shift=True)
...
kmi_props_setattr(kmi.properties, 'toggle', False)
kmi_props_setattr(kmi.properties, 'ring', False)
kmi = km.keymap_items.new('mesh.edgering_select', 'LEFTMOUSE', 'DOUBLE_CLICK', ctrl=True)
kmi_props_setattr(kmi.properties, 'extend', False)
kmi_props_setattr(kmi.properties, 'deselect', False)
kmi_props_setattr(kmi.properties, 'toggle', False)
kmi = km.keymap_items.new('mesh.edgering_select', 'LEFTMOUSE', 'DOUBLE_CLICK', shift=True, ctrl=True)
kmi_props_setattr(kmi.properties, 'extend', True)
kmi_props_setattr(kmi.properties, 'deselect', False)
kmi_props_setattr(kmi.properties, 'toggle', False)
...
kmi = km.keymap_items.new('mesh.mark_seam', 'U', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'clear', False)
kmi = km.keymap_items.new('mesh.mark_seam', 'U', 'PRESS', alt=True)
kmi_props_setattr(kmi.properties, 'clear', True)
kmi = km.keymap_items.new('mesh.separate', 'S', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('transform.edge_slide', 'S', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'use_clamp', True)
...
kmi = km.keymap_items.new('node.add_node', 'D', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'use_transform', True)
kmi_props_setattr(kmi.properties, 'type', 'ShaderNodeBsdfDiffuse')
kmi = km.keymap_items.new('node.add_node', 'Q', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'use_transform', True)
kmi_props_setattr(kmi.properties, 'type', 'ShaderNodeOutputMaterial')
...
kmi_props_setattr(kmi.properties, 'only_active', True)
...
kmi = km.keymap_items.new('pose.transforms_clear', 'C', 'PRESS', alt=True)
kmi = km.keymap_items.new('pose.ik_add', 'I', 'PRESS')
...
kmi = km.keymap_items.new('transform.transform', 'Κ', 'PRESS', ctrl=True, alt=True)
kmi_props_setattr(kmi.properties, 'mode', 'BONE_SIZE')
kmi = km.keymap_items.new('anim.keyframe_insert_menu', 'Κ', 'PRESS')
kmi = km.keymap_items.new('anim.keyframe_delete_v3d', 'Κ', 'PRESS', alt=True)
...
kmi = km.keymap_items.new('curve.separate', 'S', 'PRESS', alt=True)
kmi = km.keymap_items.new('curve.subdivide', 'S', 'PRESS', shift=True)
...
kmi = km.keymap_items.new('transform.transform', 'R', 'PRESS', shift=True)
...
kmi_props_setattr(kmi.properties, 'extend', True)
kmi = km.keymap_items.new('uv.select_loop', 'LEFTMOUSE', 'DOUBLE_CLICK')
kmi_props_setattr(kmi.properties, 'extend', False)
kmi = km.keymap_items.new('uv.select_loop', 'LEFTMOUSE', 'DOUBLE_CLICK', shift=True)
kmi_props_setattr(kmi.properties, 'extend', True)
...
kmi = km.keymap_items.new('sequencer.select_grouped', 'G', 'PRESS', ctrl=True)
...
kmi = km.keymap_items.new('gpencil.select_all', 'A', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'action', 'TOGGLE')
kmi = km.keymap_items.new('gpencil.select_all', 'I', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'action', 'INVERT')
kmi = km.keymap_items.new('gpencil.select_circle', 'C', 'PRESS')
kmi = km.keymap_items.new('gpencil.select_lasso', 'EVT_TWEAK_R', 'ANY', ctrl=True)
kmi_props_setattr(kmi.properties, 'deselect', True)
kmi_props_setattr(kmi.properties, 'extend', False)
kmi = km.keymap_items.new('gpencil.select_lasso', 'EVT_TWEAK_R', 'ANY', shift=True, ctrl=True)
kmi_props_setattr(kmi.properties, 'deselect', True)
kmi = km.keymap_items.new('gpencil.select', 'LEFTMOUSE', 'CLICK')
kmi = km.keymap_items.new('gpencil.select_linked', 'L', 'PRESS')
kmi = km.keymap_items.new('gpencil.select_linked', 'L', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('gpencil.select_more', 'WHEELUPMOUSE', 'PRESS', shift=True, ctrl=True)
kmi = km.keymap_items.new('gpencil.select_less', 'WHEELDOWNMOUSE', 'PRESS', shift=True, ctrl=True)
kmi = km.keymap_items.new('gpencil.duplicate_move', 'D', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('wm.call_menu', 'DEL', 'PRESS')
...
kmi_props_setattr(kmi.properties, 'unselected', True)
kmi = km.keymap_items.new('transform.translate', 'W', 'PRESS', shift=True)
kmi_props_setattr(kmi.properties, 'gpencil_strokes', True)
kmi = km.keymap_items.new('gpencil.select_border', 'EVT_TWEAK_S', 'ANY')
kmi_props_setattr(kmi.properties, 'extend', False)
kmi = km.keymap_items.new('gpencil.select_border', 'EVT_TWEAK_S', 'ANY', shift=True)
kmi = km.keymap_items.new('gpencil.select_border', 'EVT_TWEAK_S', 'ANY', ctrl=True)
kmi = km.keymap_items.new('transform.mirror', 'M', 'PRESS', ctrl=True)
kmi_props_setattr(kmi.properties, 'gpencil_strokes', True)
...
kmi_props_setattr(kmi.properties, 'value', 1.1754943508222875e-38)
...
kmi_props_setattr(kmi.properties, 'data_path', 'user_preferences.inputs.ndof_sensitivity')
kmi_props_setattr(kmi.properties, 'value', 0.9090909361839294)
...
kmi_props_setattr(kmi.properties, 'extend', False)
kmi_props_setattr(kmi.properties, 'camera', False)
...
kmi = km.keymap_items.new('marker.rename',             'F2',             'PRESS')
kmi = km.keymap_items.new('marker.rename',             'SELECTMOUSE',    'DOUBLE_CLICK')
...
kmi = km.keymap_items.new('time.start_frame_set', 'SELECTMOUSE', 'PRESS', ctrl=True)
kmi = km.keymap_items.new('time.end_frame_set', 'ACTIONMOUSE', 'PRESS', ctrl=True)
...
kmi = km.keymap_items.new('text.run_script', 'F5', 'PRESS')
