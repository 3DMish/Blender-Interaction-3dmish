...
kmi_props_setattr(kmi.properties, 'deselect', True)
kmi = km.keymap_items.new('mesh.faces_select_linked_flat', 'S', 'PRESS')
kmi_props_setattr(kmi.properties, 'sharpness', 3.1415927410125732)
...
kmi = km.keymap_items.new('wm.context_toggle', 'TAB', 'PRESS')
